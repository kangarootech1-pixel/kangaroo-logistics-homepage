...
export const Hero = () => {
  ...
  const sideGradient =
    dir === "rtl"
      ? "bg-gradient-to-l from-black/55 to-transparent"
      : "bg-gradient-to-r from-black/55 to-transparent";
  ...
  return (
    ...
    >
      ...
      />
      {/* Darkening overlay — balanced black wash, warehouse stays clearly visible */}
